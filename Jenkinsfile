pipeline{
    ...
    stages
    {
        ...
        stage("Deploy")
        {
            ...
            steps{
                sshagent(['shashwat']) {
                sh "scp -o StrictHostKeyChecking=no  /var/lib/jenkins/workspace/jenkinscapstone_Production/target/hello-0.0.1-SNAPSHOT.jar ubuntu@172.31.41.185:/home/ubuntu/"
                }
            }
        } 
    }
